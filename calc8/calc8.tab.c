...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_asignacion = 18,                /* asignacion  */
  YYSYMBOL_impresion = 19,                 /* impresion  */
...
{
       0,   134,   134,   136,   142,   145,   147,   149,   152,   156,
     162,   165,   167,   169,   171,   173,   176,   178,   180,   183,
     185,   187
};
#endif
...
static const char *const yytname[] =
{
  ...
  "'='", "'+'", "'-'", "'*'", "'/'", "SIGNO_UNARIO", "'\\n'", "'@'", "'('",
  "')'", "$accept", "axioma", "sentencia", "asignacion", "impresion",
...
{
      -9,    19,    -9,    -9,     2,    24,    24,    -9,    -1,    -1,
      -7,    -9,    -9,    36,    -9,    -9,     7,    -9,    -9,    -9,
      36,    27,    -9,    -1,    -1,    -1,    -1,    -9,    36,    -9,
      30,    30,    -9,    -9
};
...
{
       2,     0,     1,    20,    19,     0,     0,     4,     0,     0,
       0,     6,     7,     5,    11,    16,     0,    19,    17,    18,
      10,     0,     3,     0,     0,     0,     0,     9,     8,    21,
      12,    13,    14,    15
};
...
{
      20,    21,     3,    17,    22,     5,     6,    16,    28,     0,
       3,     4,     9,     5,     6,    30,    31,    32,    33,     2,
       9,    27,     3,     4,     0,     5,     6,     3,    17,     0,
       7,     8,     9,    23,    24,    25,    26,     9,    25,    26,
       0,    29,    23,    24,    25,    26,    18,    19
};

static const yytype_int8 yycheck[] =
{
       8,     9,     3,     4,    11,     6,     7,     5,    16,    -1,
       3,     4,    13,     6,     7,    23,    24,    25,    26,     0,
      13,    16,     3,     4,    -1,     6,     7,     3,     4,    -1,
      11,    12,    13,     6,     7,     8,     9,    13,     8,     9,
      -1,    14,     6,     7,     8,     9,     5,     6
};
...
{
       0,    16,     0,     3,     4,     6,     7,    11,    12,    13,
      17,    18,    19,    20,    21,    22,     5,     4,    22,    22,
      20,    20,    11,     6,     7,     8,     9,    18,    20,    14,
      20,    20,    20,    20
};
...
#line 1251 "calc8.tab.c"
  ...
  case 3: /* axioma: axioma sentencia '\n'  */
#line 136 "calc8.y"
                                            { 
...
#line 1261 "calc8.tab.c"
    break;

  case 4: /* axioma: axioma '\n'  */
#line 142 "calc8.y"
                                        { ; }
#line 1267 "calc8.tab.c"
    break;

  case 5: /* sentencia: expresion  */
#line 145 "calc8.y"
                                        { yyval.node = yyvsp[0].node; }
#line 1273 "calc8.tab.c"
    break;
...
#line 1279 "calc8.tab.c"
  ...
  case 7: /* sentencia: impresion  */
#line 149 "calc8.y"
                                        { yyval.node = yyvsp[0].node; }
#line 1285 "calc8.tab.c"
    break;

  case 8: /* asignacion: VARIABLE '=' expresion  */
#line 152 "calc8.y"
                                        {
                                          t_node *var_node = createASTNode(char_to_string(yyvsp[-2].indice), 0, NULL, NULL);
                                          yyval.node = createASTNode("setq", 2, var_node, yyvsp[0].node);
                                        }
#line 1294 "calc8.tab.c"
    break;

  case 9: /* asignacion: VARIABLE '=' asignacion  */
#line 156 "calc8.y"
                                        { // SOPORTE PARA ASIGNACIONES ENCADENADAS
                                          t_node *var_node = createASTNode(char_to_string(yyvsp[-2].indice), 0, NULL, NULL);
                                          yyval.node = createASTNode("setq", 2, var_node, yyvsp[0].node);
                                        }
#line 1303 "calc8.tab.c"
  ...
  case 10: /* impresion: '@' expresion  */
#line 162 "calc8.y"
                                        { yyval.node = createASTNode("print", 1, yyvsp[0].node, NULL); }
...
#line 173 "calc8.y"
                                        { yyval.node = createASTNode("/", 2, yyvsp[-2].node, yyvsp[0].node); }
#line 1339 "calc8.tab.c"
    break;

  case 16: /* termino: operando  */
#line 176 "calc8.y"
                                                    { yyval.node = yyvsp[0].node; }
#line 1345 "calc8.tab.c"
    break;

  case 17: /* termino: '+' operando  */
#line 178 "calc8.y"
                                            { yyval.node = yyvsp[0].node; }
#line 1351 "calc8.tab.c"
    break;

  case 18: /* termino: '-' operando  */
#line 180 "calc8.y"
                                            { yyval.node = createASTNode("-", 1, yyvsp[0].node, NULL); }
#line 1357 "calc8.tab.c"
    break;

  case 19: /* operando: VARIABLE  */
#line 183 "calc8.y"
                                                    { yyval.node = createASTNode(char_to_string(yyvsp[0].indice), 0, NULL, NULL); }
#line 1363 "calc8.tab.c"
    break;

  case 20: /* operando: NUMERO  */
#line 185 "calc8.y"
                                                            { yyval.node = createASTNode(int_to_string(yyvsp[0].valor), 0, NULL, NULL); }
#line 1369 "calc8.tab.c"
    break;

  case 21: /* operando: '(' expresion ')'  */
#line 187 "calc8.y"
